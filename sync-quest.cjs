...
patch('<head><meta charset="UTF-8">','<head><meta charset="UTF-8"><link rel="icon" href="data:image/svg+xml,%3Csvg xmlns=%27http://www.w3.org/2000/svg%27 viewBox=%270 0 64 64%27%3E%3Cpath fill=%27%23315c44%27 d=%27M4 30 32 6 60 30v28H38V38H26v20H4Z%27/%3E%3C/svg%3E">');
...
patch('Ti.addPass(new qx);const xe=','Ti.addPass(new qx);}const xe=');
