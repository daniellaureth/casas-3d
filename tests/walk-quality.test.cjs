...
test('walking uses the same lighting path when moving, idle, or editing',()=>{
  ...
  const frameContext=vm.createContext({
    Br:0,document:{hidden:false},questMode:null,houseTour:null,updateDesktopExperience:()=>false,Io:0,yi:false,fs:false,Xe:0,Vn:false,Un:1,Zn:true,hn:100,Be:100,De:null,
